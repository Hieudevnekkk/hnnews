                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('title', $model->title) }}"
                                            name="title" id="title">
                                        @error('title')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('sub_title', $model->sub_title) }}" name="sub_title"
                                            id="sub_title">
                                    </div>
                                    <div class="mt-3">
                                        <label for="slug" class="form-label">Đường dẫn</label>
                                        <input type="text" class="form-control" value="{{ old('slug', $model->slug) }}"
                                            name="slug" id="slug">
                                        @error('slug')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="text" class="form-control"
                                            value="{{ old('name_author', $model->name_author) }}" name="name_author"
                                            id="name_author">
                                        @error('name_author')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-check-secondary mb-3 mt-3">
                                                <input class="form-check-input" type="checkbox" id="formCheck7"
                                                    name="is_hot" value="1"
                                                    {{ old('is_hot', $model->is_hot) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check form-check-secondary mb-3 mt-3">
                                                <input class="form-check-input" type="checkbox" id="formCheck7"
                                                    ...
                                                    {{ old('is_hot', $model->is_featured) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="formCheck7">
                                                    Tin đặc trưng
                                                </label>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check form-check-secondary mb-3 mt-3">
                                                <input class="form-check-input" type="checkbox" id="formCheck7"
                                                    ...
                                                    {{ old('is_hot', $model->is_most_popular) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="formCheck7">
                                                    Tin phổ biến nhất
                                                </label>
                                            </div>
                                            <div class="form-check form-check-secondary mb-3 mt-3">
                                                <input class="form-check-input" type="checkbox" id="formCheck7"
                                                    ...
                                                    {{ old('is_hot', $model->is_trending) ? 'checked' : '' }}>
                                                <label class="form-check-label" for="formCheck7">
                                                    Tin tức xu hướng
                                                </label>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!-- Hiển thị ảnh -->
                                    <div class="mt-3">
                                        <img id="image-preview" src="{{ \Storage::url($model->image) }}"
                                            alt="Image Preview" class="img-thumbnail"
                                            style="max-width: 200px; display: block;">
                                    </div>
                                    <div class="input-group mt-3">
                                        <span class="input-group-text">Nội dung</span>
                                        <textarea class="form-control" aria-label="With textarea" rows="2" name="content">{{ old('content', $model->content) }}</textarea>
                                    </div>
                                    @error('content')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
