                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('admin/theme/assets/images/logo-sm.png') }}" alt=""
                                        height="22" />
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('admin/theme/assets/images/logo-dark.png') }}" alt=""
                                        height="17" />
                                </span>
                            </a>
                            ...
                            <a href="index.html" class="logo logo-light">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('admin/theme/assets/images/logo-light.png') }}" alt=""
                                        height="17" />
                                </span>
                            </a>
                        </div>
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="dropdown ms-1 topbar-head-dropdown header-item">
                            <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                                ...
                                <img id="header-lang-img" src="{{ asset('admin/theme/assets/images/flags/us.svg') }}"
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language py-2"
                                    ...
                                    <img src="{{ asset('admin/theme/assets/images/flags/us.svg') }}" alt="user-image"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin/theme/assets/images/flags/spain.svg') }}"
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin/theme/assets/images/flags/germany.svg') }}"
                                        alt="user-image" class="me-2 rounded" height="18" />
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin/theme/assets/images/flags/italy.svg') }}"
                                        alt="user-image" class="me-2 rounded" height="18" />
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin/theme/assets/images/flags/russia.svg') }}"
                                        alt="user-image" class="me-2 rounded" height="18" />
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin/theme/assets/images/flags/china.svg') }}"
                                        alt="user-image" class="me-2 rounded" height="18" />
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin/theme/assets/images/flags/french.svg') }}"
                                        alt="user-image" class="me-2 rounded" height="18" />
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                    ...
                                    <img src="{{ asset('admin/theme/assets/images/flags/ae.svg') }}" alt="user-image"
                                        class="me-2 rounded" height="18" />
                            ...
                            <div class="dropdown-menu dropdown-menu-lg p-0 dropdown-menu-end">
                                ...
                                <div class="p-2">
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="{{ asset('admin/theme/assets/images/brands/github.png"') }}"
                                                    alt="Github" />
                                                <span>GitHub</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="{{ asset('admin/theme/assets/images/brands/bitbucket.png"') }}"
                                                    alt="bitbucket" />
                                                <span>Bitbucket</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="{{ asset('admin/theme/assets/images/brands/dribbble.png"') }}"
                                                    alt="dribbble" />
                                                <span>Dribbble</span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="{{ asset('admin/theme/assets/images/brands/dropbox.png"') }}"
                                                    alt="dropbox" />
                                                <span>Dropbox</span>
                                            </a>
                                        </div>
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="{{ asset('admin/theme/assets/images/brands/mail_chimp.png"') }}"
                                                    alt="mail_chimp" />
                                        ...
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#!">
                                                <img src="{{ asset('admin/theme/assets/images/brands/slack.png"') }}"
                                                    alt="slack" />
                                                <span>Slack</span>
                                            </a>
                                        </div>
                                ...
                                <div data-simplebar style="max-height: 300px">
                                    <div class="p-2">
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('admin/theme/assets/images/products/img-1.png') }}"
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('admin/theme/assets/images/products/img-2.png') }}"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light"
                                                    alt="user-pic" />
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('admin/theme/assets/images/products/img-3.png') }}"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light"
                                                    alt="user-pic" />
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('admin/theme/assets/images/products/img-6.png') }}"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light"
                                                    alt="user-pic" />
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                                        ...
                                        <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                            <div class="d-flex align-items-center">
                                                <img src="{{ asset('admin/theme/assets/images/products/img-5.png') }}"
                                                    class="me-3 rounded-circle avatar-sm p-2 bg-light"
                                                    alt="user-pic" />
                                                <div class="flex-grow-1">
                                                    <h6 class="mt-0 mb-1 fs-14">
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ asset('admin/theme/assets/images/users/avatar-1.jpg') }}"
                                        alt="Header Avatar" />
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <form action="{{ route('auth.logout') }}" method="POST">
                                    @csrf
                                    <button class="dropdown-item" href="{{ route('auth.logout') }}"><i
