...
<script src="{{ asset('admin/theme/assets/js/pages/plugins/lord-icon-2.1.0.js') }}"></script>
<script src="{{ asset('admin/theme/assets/js/plugins.js') }}"></script>
...
<!-- Vector map-->
<script src="{{ asset('admin/theme/assets/libs/jsvectormap/js/jsvectormap.min.js') }}"></script>
<script src="{{ asset('admin/theme/assets/libs/jsvectormap/maps/world-merc.js') }}"></script>

<!--Swiper slider js-->
<script src="{{ asset('admin/theme/assets/libs/swiper/swiper-bundle.min.js') }}"></script>

<!-- Dashboard init -->
<script src="{{ asset('admin/theme/assets/js/pages/dashboard-ecommerce.init.js') }}"></script>
